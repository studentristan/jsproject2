...
function printBill() {
   console.log(`\nHello ${custFirst} ${custLast}, you are ${age}. Your premium due date is ${premiumDueDateMonth}, ${premiumDueDateDay}, ${premiumDueDateYear}, and your policy number is ${policyNumber}. Your number of at-fault accidents is ${atFault}. Your bill will be $${premiumPrice}`);
}
